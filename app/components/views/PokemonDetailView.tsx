  ...
  const getEvolutionFamily = () => {
    ...
    evolutionRows.forEach((row) => {
      const chain = row.ids.map((id) => {
        const pokemon = state.allPokemon.find((p) => p.id.toString() === id);
                          ...
                          <div className="flex flex-wrap justify-center gap-6">
                            {form.evolution_chain?.map(
                              (chain, chainIndex: number) => {
                                ...
                                const getAlolanFormImage = (
                                  pokemonId: number,
                                ) => {
                                  try {
                                    const pokemonWithAlolanForm =
                                      state.allPokemon.find(
                                        (p) =>
                                          p.id === pokemonId &&
                                          p.forms &&
                                          p.forms.some(
                                    ...
                                    if (
                                      ...
                                      const alolanForm =
                                        pokemonWithAlolanForm.forms.find(
                                          (f) => f.name === "Alolan",
                                        );
                                ...
                                return (
                                  ...
                                  >
                                    {fromPokemon && (
                                      <button
                                        onClick={() =>
                                          handlePokemonClick(fromPokemon.id)
                                        }
                                        className="text-center cursor-pointer hover:scale-105 transition-transform"
                                      >
                                        <div className="w-24 h-24 mb-0">
                                    ...
                                    {toPokemon && (
                                      <button
                                        onClick={() =>
                                          handlePokemonClick(toPokemon.id)
                                        }
                                        className="text-center cursor-pointer hover:scale-105 transition-transform"
                                      >
                                        <div className="w-24 h-24 mb-0">
